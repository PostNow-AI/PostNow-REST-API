...
class WeeklyContextCurrentView(generics.GenericAPIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            # Get ranked opportunities from tendencies_data
            ...
            response_data = {
                ...
                'has_next': False,  # Always False for current week
...
class WeeklyContextHistoryView(generics.GenericAPIView):
    ...
    def get(self, request):
        ...
        try:
            # Get all contexts ordered by date
            ...
            # Get specific context by offset
